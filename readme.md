...
[![Global support: 91.98%](https://img.shields.io/badge/global%20support-91.98%25-brightgreen)](https://caniuse.com/#feat=mdn-javascript_builtins_array_from)  ![GitHub file size in bytes](https://img.shields.io/github/size/MathiasWP/TeroyJS/Teroy.min.js) ![npm](https://img.shields.io/npm/v/teroy)
&nbsp;
...
TeroyJS focuses mainly on one thing: **size**. A minified TeroyJS takes only 2 777 bytes (2.77kb, 1.15kb gzip) of space on your webpage, which clears up a lot of room for you beautiful code instead. TeroyJS also works silently behind the scenes with the power of JavaScript Proxies and will only update the nescessary DOM-components on state changes. There's no virtual DOM (like in React), and the speed of TeroyJS is not limited by thousands of line with code. In other words:
